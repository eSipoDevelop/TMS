...
function TransporteFormulario() {
  ...
  return (
    <div
      className={`mt-6 p-6 rounded-lg shadow-md w-full max-w-2xl transition-all ${
        editando ? "bg-yellow-100" : "bg-white"
      }`}
    >
      <h2
        className={`text-lg font-semibold mb-4 ${
          editando ? "text-yellow-700" : "text-gray-800"
        }`}
      >
